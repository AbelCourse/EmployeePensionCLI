...
public class EmployeePensionApp {
    ...
    public static void main(String[] args) {
        ...
        // Print list of all employees in JSON format
        System.out.println("Employees");
        printAllEmployeesJson();
        // Print Monthly Upcoming Enrollees report
        System.out.println("Monthly Employees");
        printUpcomingEnrolleesJson();
    }

    private static void initializeEmployees() {
        // Load employees data into the application
        ...
        // Link pension plans to employees
